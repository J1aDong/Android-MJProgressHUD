...
public class MainActivity extends Activity
{
	...
	{
		mjProgressHUD.showWithStatus("load...");
	}

	public void showInfoWithStatus(View view)
	{
		mjProgressHUD
				.showInfoWithStatus("这是提示", MJProgressHUD.SVProgressHUDMaskType.None);
	}

	public void showSuccessWithStatus(View view)
	{
		mjProgressHUD.showSuccessWithStatus("恭喜，提交成功！");
	}

	public void showErrorWithStatus(View view)
	{
		mjProgressHUD
				.showErrorWithStatus("不约，叔叔我们不约～", MJProgressHUD.SVProgressHUDMaskType.GradientCancel);
	}
			...
			switch( msg.what )
			{
				case 0:
									...
									.getProgress() )
					{
						...
						mjProgressHUD.setText("进度 " + progress + "%");
	...
	public void showWithProgress(View view)
	{
		...
		mjProgressHUD.showWithProgress("进度 " + progress
