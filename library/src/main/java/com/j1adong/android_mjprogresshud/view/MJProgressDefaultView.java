 ...
 */
public class MJProgressDefaultView extends LinearLayout {
    // private int resBigLoading = R.drawable.ic_svstatus_loading;
    private int resInfo = R.drawable.ic_mjstatus_info;
    private int resSuccess = R.drawable.ic_mjstatus_success;
    private int resError = R.drawable.ic_mjstatus_error;
    private ImageView ivBigLoading, ivSmallLoading;
    private MJCircleProgressBar circleProgressBar;
    ...
    public MJProgressDefaultView(Context context) {
        super(context);
        initViews();
        init();
    }
    ...
    private void initViews() {
        LayoutInflater.from(getContext())
                .inflate(R.layout.view_mjprogressdefault, this, true);
        ivBigLoading = (ImageView) findViewById(R.id.ivBigLoading);
        llRoot = (LinearLayout) findViewById(R.id.ll_root);
        ivSmallLoading = (ImageView) findViewById(R.id.ivSmallLoading);
        circleProgressBar = (MJCircleProgressBar) findViewById(R.id.circleProgressBar);
    ...
    public MJCircleProgressBar getCircleProgressBar() {
